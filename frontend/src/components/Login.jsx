...
import { Button, Row, Col, Container, Card, Form, Alert, FloatingLabel } from 'react-bootstrap';
          ...
          <Row>
            <Card className="shadow p-0">
              <Card.Body>
                <Row>
                  <Col md={6}>
                    <Card.Img variant="top" className="auth__img object-fit-cover rounded" src={tunnel} />
                  </Col>
                  <Col md={6}>
                    <Row className="flex-column justify-content-center h-100">
                    <Card.Title className="fs-2 text-center mb-3">Войти</Card.Title>
                      ...
                      <FloatingLabel
                        ...
                        className="mb-3"
                      >
                        <Form.Control type="text" name="nick"
                      ...
                      >
                        ...
                        <Button variant="info" className="w-100 mt-3" type="submit">Войти</Button>
                      </Form>
                    </Row>
              ...
              <Card.Footer className="text-center pt-3 pb-2">
                ...
                <Button variant="link" href="/reg">Зарегистрироваться</Button>
              </Card.Footer>
            </Card>
          </Row>
          </Col>
