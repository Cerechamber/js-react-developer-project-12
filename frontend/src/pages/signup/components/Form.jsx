  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object().shape({
      ...
      confirmPassword: Yup.string().oneOf(
        ...
        'signUpForm.validation.confirmPassword'
      ),
    }),
      ...
      <fieldset disabled={formik.isSubmitting}>
        ...
        <Form.Group className='form-floating mb-3'>
          <Form.Control
            ...
            id='username'
            isInvalid={
              (formik.touched.username && formik.errors.username) || userExists
            }
          />
        ...
        <Form.Group className='form-floating mb-3'>
          <Form.Control
            ...
            id='password'
            isInvalid={
              (formik.touched.password && formik.errors.password) || userExists
            }
          />
          <Form.Control.Feedback type='invalid' tooltip>
        ...
        <Form.Group className='form-floating mb-4'>
          ...
          />
          <Form.Control.Feedback type='invalid' tooltip>
            {formik.errors.confirmPassword && !userExists
