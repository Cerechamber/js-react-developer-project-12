...
const channelsSlice = createSlice({
  ...
  reducers: {
    ...
    deleteChannel(state, action) {
      ...
      state.channels = channels.filter(
        (channel) => channel.id !== remoteChannelId
      );
      state.currentChannelId =
        currentChannelId === remoteChannelId
          ? defaultChannelId
          : currentChannelId;
    },
...
export const selectCurrentChannel = createSelector(
  ...
  (channels, currentChannelId) =>
    channels.filter(({ id }) => id === currentChannelId)
);
...
export const { setCurrentChannel, addChannel, deleteChannel, updateChannel } =
